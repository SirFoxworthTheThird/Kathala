...
const entry = {
  ...
  notice: 'Unofficial reference for a public-domain ancient epic. Structural summaries and editorial chronology are original Kathala material; scene drafts reproduce Samuel Butler’s public-domain translation. The cover is an original AI-generated interpretation created for Kathala; source, map sourcing, and editorial method are recorded in Lore.',
