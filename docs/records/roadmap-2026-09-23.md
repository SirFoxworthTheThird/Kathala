> **This is the roadmap as it stood on 23 September 2026, archived whole.**
>
> One hundred and eighty-four completed items had accumulated under a dozen open
> ones, and the open ones were unfindable. The live roadmap is now
> [`ROADMAP.md`](../../ROADMAP.md) at the root of the repository and holds only
> work that is actually intended.
>
> This file is a record: it keeps every shipped item, with the detail written at
> the time about what was built and why. It is not updated. Several entries
> describe decisions — why fractional ordering belongs to #118, what `#115`
> owed and what it did not — that are worth having in the words of the person
> who made them.
>
> It also keeps the items that were dropped when the roadmap was split. The
> reasons are in `ROADMAP.md`, under *Considered and not doing*.
