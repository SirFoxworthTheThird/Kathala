...
import { browseLibrary, groupByProse } from '@/lib/libraryBrowse'
...
export function LibraryDialog({
  ...
  */
  ...
  /** One catalogue card. Declared here because both shelves render it. */
      ...
      <div className="w-full max-w-2xl rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-xl">
        ...
        <div className="px-4 py-3">
          ...
          */}
          ...
          {/*
            Two shelves, because they are two different offers: one you can read
            and one you can only look at. A search narrows both, and a shelf with
            nothing left in it takes its heading with it — an empty "Structure
